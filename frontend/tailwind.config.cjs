  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'pack-spin-3d':   'packSpin3D 8s ease-in-out infinite',
        'fade-in-up':     'fadeInUp 0.5s ease-out both',
        'card-reveal':    'cardReveal 0.4s ease-out both',
      },
      keyframes: {
        'fade-in': {
          '0%':   { opacity: '0' },
        ...
        packSpin3D: {
          '0%, 100%': { transform: 'perspective(800px) rotateY(-8deg) rotateX(3deg)' },
          '25%':      { transform: 'perspective(800px) rotateY(0deg) rotateX(-2deg)' },
          '50%':      { transform: 'perspective(800px) rotateY(8deg) rotateX(3deg)' },
          '75%':      { transform: 'perspective(800px) rotateY(0deg) rotateX(-2deg)' },
        },
        fadeInUp: {
